...
book_info = BookInfo(book.title, 10, info=True)
...
print(
    book_info.title, str(book_info.stars) + " stars", book_info.price
    , sep=", "
)
# Print all properties of book and book_info objects
print("Book properties: ", vars(book))
print("BookInfo properties: ", vars(book_info))
